    ...
    <header className="sticky top-0 z-50 bg-nav border-b border-edge h-[65px] flex items-center justify-center px-4 md:px-6 overflow-hidden transition-colors duration-300">
      <div className="max-w-[1440px] flex items-center justify-between w-full">
        ...
        <div className="flex items-center gap-2 sm:gap-4 shrink-0">
          <button className="text-[14px] sm:text-[16px] font-bold text-heading dark:text-white px-3 sm:px-4 py-1.5 sm:py-2 rounded-full border border-edge hover:bg-black/5 dark:hover:bg-white/5 transition-colors duration-300 cursor-pointer">
            Registrar-se
          </button>
          <button className="text-[14px] sm:text-[16px] font-bold text-white bg-brand px-4 sm:px-6 py-1.5 sm:py-2 rounded-full shadow-[0px_4px_6px_-4px_rgba(13,147,242,0.2),0px_10px_15px_-3px_rgba(13,147,242,0.2)] hover:bg-brand/90 transition-colors duration-300 cursor-pointer">
            Login
          </button>
        </div>
      </div>
